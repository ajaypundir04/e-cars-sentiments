...
from utils.feature_selection_pipeline import FeatureSelector  
...
class FeatureExtractor:
    ...
    def extract_features_from_url(self, url, key_word_map):
        ...
        features = FeatureSelector.extract_features_transformer(cleaned_posts)
        self.logger.info(f"Extracted features using transformer embeddings: {features}")

        # Extract Named Entities
        entities = [FeatureSelector.extract_entities(text) for text in cleaned_posts]
